    ...
    <>
      ...
      <div className={s.hero}>
        <div className={s.container}>
          <div className={s.heroEyebrow}>AI-powered · ready in 60 seconds</div>
          <h1>Your dog deserves a plan<br />built <em>for them.</em> Not for someone else&apos;s.</h1>
          <p className={s.heroSub}>Tell us about your dog. We&apos;ll generate a complete, personalized 30-day training program — breed-specific, problem-focused, and ready to work.</p>
          <div className={s.heroCtaGroup}>
            <Link href="/form" className={s.btnPrimary}>Build my dog&apos;s plan — $17</Link>
            <span className={s.heroMicro}>One-time payment. Instant delivery. No fluff.</span>
          </div>
        </div>
      </div>
      ...
      <section className={s.section}>
        <div className={s.container}>
          ...
          <div className={s.problemList}>
            {[
              { emoji: '🦮', title: 'The pulling hasn\'t stopped', body: 'Every walk is a battle. You\'ve tried stopping, turning, treats — nothing lasts more than a few minutes before it\'s back to tug of war.' },
      ...
      <section className={s.section}>
        <div className={s.container}>
          <AnimateOnScroll className={s.solutionIntro}>
            ...
            <p className={s.lead}>PawPlan uses AI to do what a $150/hr private trainer would do in an initial consultation — analyse your dog&apos;s specific profile and build a step-by-step program from scratch. In 60 seconds. For $17.</p>
          </AnimateOnScroll>
          ...
          <div className={s.solutionSteps}>
            {[
              ...
              { n: '3', title: 'You get a complete, ready-to-use PDF', body: 'Delivered straight to your inbox. No app to download. No video library to navigate. Just a clear, structured plan you can start today.' },
            ].map((step) => (
      ...
      <section className={s.sectionAlt} id="pricing">
        <div className={s.containerNarrow}>
          ...
          <div className={s.valueAnchor}>
            ...
            <div className={s.vaDivider}></div>
            <div className={s.valueAnchorItem}>
              <span className={s.vaLabel}>PawPlan</span>
          ...
          <div className={s.pricingCard}>
            ...
            <ul className={s.priceFeatures}>
              {['Breed & temperament diagnostic', 'Complete 30-day day-by-day program', 'Detailed exercises with duration & frequency', 'Breed-specific mistakes to avoid', 'Weekly progress checklist', 'Delivered as a polished PDF to your inbox', 'Works for any breed, age, or problem'].map((f) => (
      ...
      <div className={s.finalCta}>
        <div className={s.containerNarrow}>
          ...
          <Link href="/form" className={s.btnPrimary}>Get my dog&apos;s plan — $17</Link>
        </div>
      </div>

      {/* FOOTER */}
      <footer className={s.footer}>
        <strong>PawPlan</strong> · AI-generated personalised dog training plans<br />
        <a href="#">Privacy Policy</a> · <a href="#">Terms</a> · <a href="#">Contact</a><br /><br />
        © 2026 PawPlan. Results may vary. Always consult a veterinary professional for medical or severe behavioural issues.
      </footer>
    </>
  )
}
